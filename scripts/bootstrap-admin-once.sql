...
-- Bootstrap founder admin for alishamsian504@gmail.com
insert into public.admin_profiles (user_id, role, is_active, notes)
values ('8b3e7d9d-0bae-4c89-8f47-1145a76a6cf7', 'OWNER', true, 'Bootstrap founder admin')
...
select user_id, role, is_active from public.admin_profiles where user_id = '8b3e7d9d-0bae-4c89-8f47-1145a76a6cf7';
