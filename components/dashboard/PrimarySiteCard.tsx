        ...
        <div className="flex flex-col justify-between gap-5 p-5 md:p-6">
          <div className="space-y-4">
            <div className="grid grid-cols-3 gap-2">
              <div className="rounded-xl bg-[#f6f6f4] px-3 py-3 ring-1 ring-border/60">
              ...
              <div className="rounded-xl bg-[#f6f6f4] px-3 py-3 ring-1 ring-border/60">
                ...
                <p className="mt-1 truncate text-sm capitalize text-ink">
          ...
          <div className="space-y-3">
            <div className="flex flex-wrap gap-2">
              ...
              <Button asChild size="sm" variant={published ? "default" : "outline"}>
            ...
            <details className="group rounded-xl bg-[#f6f6f4] ring-1 ring-border/60 open:pb-2">
              <summary className="flex cursor-pointer list-none items-center gap-2 px-3 py-2.5 text-xs font-medium text-ink marker:content-none [&::-webkit-details-marker]:hidden">
