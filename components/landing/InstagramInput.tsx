...
/**
 * Single dark control: label + URL field + CTA. Fixed heights, high contrast.
 */
export function InstagramInput({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "flex flex-col overflow-hidden rounded-xl border bg-[#0a0a0a] sm:flex-row sm:items-stretch",
      ...
      >
        ...
        <button
          ...
          className={cn(
            ...
            "sm:h-auto sm:min-w-[10.5rem] sm:border-s sm:border-t-0",
