...
export const EDITOR_FIELD_CONTENT_PATH: Record<string, string> = {
  ...
  "lookbook.title": "content.lookbook.title",
  "lookbook.description": "content.lookbook.description",
  "shopTheLook.title": "content.shopTheLook.title",
  "shopTheLook.description": "content.shopTheLook.description",
  "categories.title": "content.categories.title",
  "pricing.title": "content.pricing.title",
  "pricing.description": "content.pricing.description",
  "menu.title": "content.menu.title",
  "menu.description": "content.menu.description",
  "location.title": "content.location.title",
  "portfolio.title": "content.portfolio.title",
  "properties.title": "content.properties.title",
};
